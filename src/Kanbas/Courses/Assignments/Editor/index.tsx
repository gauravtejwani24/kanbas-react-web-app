...
import {addAssignment, setAssignment,clearAssignment,updateAssignment} from "../reducer";
...
//   );
  ...
  return (
    <div>
      ...
      <textarea value ={assignment.description} className="form-control mb-2" onChange={(e)=>{dispatch(setAssignment({...assignment,"description":e.target.value}))}}/>
      <br />
                    ...
                    >
                        ...
                        <input className="form-control" type="datetime-local" value={assignment?.dueDateTime}
                            onChange={(e) => { 
                              ...
                              dispatch(setAssignment({ ...assignment, dueDateTime: e.target.value }))}} />
